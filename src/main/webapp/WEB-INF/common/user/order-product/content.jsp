			...
			<div class="col-12">
				<div class="bread-inner">
					<ul class="bread-list">
						...
						<li class="active"><a href="#">Đơn hàng của bạn</a></li>
					</ul>
				</div>
			</div>
		</div>
...
<div class="container mt-3 mb-3">
	...
	<table class="table table-hover shopping-summery">
		...
		<tbody>
		<c:forEach var="item" items="${orders}" varStatus="i">
			<tr class="text-center">
				...
				<td>
					<a href="/DTNsShop/products-order.html/order-details/${item.id}" class="text-primary">Chi tiết đơn hàng</a>
				</td>
				<td>
					<button style="background: none;outline: none;border: none;" data-bs-toggle="modal" data-bs-target="#exampleModal${i.count}" class="text-danger" ${item.status?'hidden':''}>Hủy đơn hàng</button>
				</td>
				<td>
					<!-- Modal Delete -->
                        ...
                        <div class="modal-dialog" style="width: 600px;margin: auto;">
                            <div class="modal-content">
                                ...
                                <div class="modal-body mt-4 text-center" style="height: 150px;">
                                    ...
                                    <h5 class="text-gray">Bạn chắc chắn muốn hủy đơn hàng
                                        DH00${item.id}?</h5>
                                </div>
                                <form class="modal-footer" method="post">
                                    <button class="btn btn-danger d-flex" formaction="/DTNsShop/products-order.html/cancel/${item.id}">
	...
	<div class="text-right text-white mt-2" ${ordersCount!=0?'':'hidden'}>
	...
	<div class="text-center" ${ordersCount!=0?'hidden':''}>
		<img class="img-fluid mb-5" src="/templates/user/img/cart.jpg"
			width="300px">
		<h5>Bạn chưa có đơn hàng đang chờ nào cả ! :))</h5>
