			...
			<div class="row">
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu dtn-acc1" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="/DTNsShop/register" ${sessionScope.user == null?'':'hidden'}><i class="fa fa-user-plus" aria-hidden="true"></i><s:message code="lo.mn.register"></s:message></a>
                    <a class="dropdown-item" href="/DTNsShop/login" ${sessionScope.user == null?'':'hidden'}><i class="fa fa-sign-in" aria-hidden="true"></i><s:message code="lo.mn.login"></s:message></a>
                    <a class="dropdown-item" href="/DTNsShop/updateProfile" ${sessionScope.user == null?'hidden':''}><i class="fa fa-pencil-square-o" aria-hidden="true"></i><s:message code="lo.mn.upprofile"></s:message></a>
                    
                    <a class="dropdown-item" href="/DTNsShop/forgotPass" ${sessionScope.user == null?'':'hidden'}><i class="fa fa-unlock" aria-hidden="true"></i><s:message code="lo.mn.forgotpass"></s:message></a>
                    <a class="dropdown-item" href="/DTNsShop/changePass" ${sessionScope.user == null?'hidden':''}><i class="fa fa-unlock" aria-hidden="true"></i><s:message code="lo.mn.changpass"></s:message></a>
                    <div class="dropdown-divider" ${sessionScope.user == null?'hidden':''}></div>
                    <a class="dropdown-item" href="/DTNsShop/logout" ${sessionScope.user == null?'hidden':''}><i class="fa fa-sign-out" aria-hidden="true"></i><s:message code="lo.mn.logout"></s:message></a>
                  </div>
                </li>
              </ul>
					</div>
            ...
            <div class="right-bar">
              <!-- Search Form -->
						<div class="sinlge-bar">
							<a href="/DTNsShop/product-favorite.html" class="single-icon" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Mặt hàng yêu thích">
                ...
                <div class="sinlge-bar shopping">
							<a href="/DTNsShop/carts.html" class="single-icon"><i
								...
								<div class="navbar-collapse">
									<div class="nav-inner">
										 <ul class="nav main-menu menu navbar-nav">
					                        ...
					                        <li class="active"><a href="/DTNsShop/products.html"><s:message code="home.product"></s:message> </a></li>
					                        ...
					                        <li><a href="/DTNsShop/about.html"><s:message code="home.about"></s:message> </a></li>
