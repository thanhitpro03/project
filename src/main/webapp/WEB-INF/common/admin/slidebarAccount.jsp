...
<!-- Side Navbar -->
    <nav class="side-navbar z-index-40">
        ...
        <ul class="list-unstyled py-4">
            ...
            <li class="sidebar-item"><a class="sidebar-link" href="/DTNsShop/admin">
                    <svg class="svg-icon svg-icon-sm svg-icon-heavy me-xl-2">
                        <use xlink:href="#real-estate-1"> </use>
                    </svg>Trang chủ </a></li>
            <span class="mt-2 text-uppercase text-gray-400 text-xs letter-spacing-0 mx-3 px-2 heading">Quản lý</span>
            <!-- Sildebar item -->
            <li class="sidebar-item active"><a class="sidebar-link" href="#exampledropdownDropdown0" data-bs-toggle="collapse">
