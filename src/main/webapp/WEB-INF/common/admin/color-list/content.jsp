	...
	<div class="container-fluid">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb mb-0 py-3">
				...
				<li class="breadcrumb-item active fw-light" aria-current="page">Danh sách</li>
			</ol>
		</nav>
	</div>
</div>
...
<div class="card m-3 mt-3">
	...
	<div class="text-start alert alert-success text-success w-50 float-start" role="alert"
       ...
       <button class="mt-3 btn btn-success" style="width: 180px; font-size: 16px;"
		...
		<a  class="mt-3 btn btn-primary" href="/DTNsShop/admin/product-color.html" style="width: 180px; font-size: 16px;">
		...
		<div class="row">
			...
			<form action="" method="post" class="col-4 d-flex">
				<input class="form-control me-1" name="keywords" type="text"
					placeholder="Tìm kiếm theo tên..." value="${keywords_color1}">
	...
	<div class="card-body">
			...
			<thead>
				<tr>
					<th><a class="text-dark"
						href="/DTNsShop/admin/color-list.html/sort?field=id&sort=${sort}&p=${number}">ID
					...
					<th><a class="text-dark"
						href="/DTNsShop/admin/color-list.html/sort?field=name&sort=${sort}&p=${number}">Tên
							màu sắc
							<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-down-up" viewBox="0 0 16 16">
									  <path fill-rule="evenodd" d="M11.5 15a.5.5 0 0 0 .5-.5V2.707l3.146 3.147a.5.5 0 0 0 .708-.708l-4-4a.5.5 0 0 0-.708 0l-4 4a.5.5 0 1 0 .708.708L11 2.707V14.5a.5.5 0 0 0 .5.5zm-7-14a.5.5 0 0 1 .5.5v11.793l3.146-3.147a.5.5 0 0 1 .708.708l-4 4a.5.5 0 0 1-.708 0l-4-4a.5.5 0 0 1 .708-.708L4 13.293V1.5a.5.5 0 0 1 .5-.5z"/>
									</svg>
								...
								<form method="post"
									...
									<div class="modal-content">
										<div class="modal-header">
											...
											<button
												${showEdit? '
                                        formaction="/DTNsShop/admin/color-list.html/cancel"': ''}
										...
										<div class="container">
											...
											<div class="modal-body row">
												...
												<div class="mb-3 col-12">
													<label for="exampleInputMaSP" class="form-label">*Tên màu sắc: </label> <input type="text" class="form-control" id="name"
														name="name"
														value="${items2 != null?items2.name:item.name}">
													<div class="text-danger mt-1" ${messageN==null?'hidden':''}
														style="font-size: 13px;">${messageN}</div>
												</div>
												<div class="ms-3 alert alert-success text-success col-11"
											...
											<div class="modal-footer">
												<div class="text-end">
													<button class="btn btn-success"
														formaction="/DTNsShop/admin/color-list.html/update/${items2.id != null?items2.id:item.id}">
														<svg xmlns="http://www.w3.org/2000/svg" width="20"
													...
													<button class="btn btn-info" data-bs-dismiss="modal"
														${showEdit? 'formaction="/DTNsShop/admin/color-list.html/cancel"': ''}>
														<svg xmlns="http://www.w3.org/2000/svg" width="20"
															height="20" fill="currentColor" class="bi bi-pen-fill"
															viewBox="0 0 20 20">
                                                            <path
								...
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-body text-center">
											...
											<h5 class="text-gray">Bạn chắc chắn muốn xóa màu sắc
												"${item.name}" ?</h5>
										</div>
										<form class="modal-footer" method="post">
											<button class="btn btn-danger"
												formaction="/DTNsShop/admin/color-list.html/delete/${item.id}">
												<svg xmlns="http://www.w3.org/2000/svg" width="20"
													height="20" fill="currentColor" class="bi bi-pen-fill"
													viewBox="0 0 20 20">
                                                    <path
		...
		<div class="text-end">
			<a class="btn btn-dark ${items.number-1 < 0?' disabled':''}"
				href="/DTNsShop/admin/color-list.html/sort?field=${field2}&sort=0&p=0">First</a>
			<a class="btn btn-dark  ${items.number-1 < 0?'disabled':''} "
				href="/DTNsShop/admin/color-list.html/sort?field=${field2}&sort=0&p=${items.number-1 < 0?'0':items.number-1}">Previous</a>
			<a
				class="btn btn-dark  ${items.number+1 > items.totalPages - 1 ?'disabled':''}"
				href="/DTNsShop/admin/color-list.html/sort?field=${field2}&sort=0&p=${items.number+1 > items.totalPages - 1 ? items.totalPages - 1: items.number+1}">Next</a>
			<a
				class="btn btn-dark  ${items.number+1 > items.totalPages - 1 ?'disabled':''}"
				href="/DTNsShop/admin/color-list.html/sort?field=${field2}&sort=0&p=${items.totalPages-1}">Last</a>
		</div>
	</div>
</div>
<!-- Modal Add -->
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<button class="btn-close"
					${show?' formaction="/DTNsShop/admin/color-list.html/cancel"':''}
					data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
...
<!-- 					<div class="mb-3 col-12">
			...
			<div class="modal-footer bg-white text-end container">
				<div class="col-12">
					<button class="btn btn-success"
						formaction="/DTNsShop/admin/color-list.html/add">
						<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
							fill="currentColor" class="bi bi-pen-fill" viewBox="0 0 20 20">
                <path
								d="M2 1a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H9.5a1 1 0 0 0-1 1v7.293l2.646-2.647a.5.5 0 0 1 .708.708l-3.5 3.5a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L7.5 9.293V2a2 2 0 0 1 2-2H14a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h2.5a.5.5 0 0 1 0 1H2z" />
