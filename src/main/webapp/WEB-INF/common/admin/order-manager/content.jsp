...
<div class="card m-3 mt-3">
	...
	<div class="text-start alert alert-success text-success w-50 float-start" role="alert"
				...
				<a class="btn btn-success" style="width:200px;font-size:16px;" href="/DTNsShop/admin/order-delivered.html">
	  			...
	  			<a class="btn btn-danger" style="width:200px;font-size:16px;" href="/DTNsShop/admin/order-cancel.html">
		          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-pen-fill" viewBox="0 0 20 20">
					<path d="M2 1a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H9.5a1 1 0 0 0-1 1v7.293l2.646-2.647a.5.5 0 0 1 .708.708l-3.5 3.5a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L7.5 9.293V2a2 2 0 0 1 2-2H14a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h2.5a.5.5 0 0 1 0 1H2z"/>
				</svg>
		       		Đơn hàng đã hủy
	  			</a>
	  			<!-- <a class="btn btn-danger" style="width:180px;font-size:16px;" href="/DTNsShop/admin/order-manager.html">
		          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-pen-fill" viewBox="0 0 20 20">
					<path d="M2 1a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H9.5a1 1 0 0 0-1 1v7.293l2.646-2.647a.5.5 0 0 1 .708.708l-3.5 3.5a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L7.5 9.293V2a2 2 0 0 1 2-2H14a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h2.5a.5.5 0 0 1 0 1H2z"/>
				</svg>
		       		Đơn hàng đang chờ
...
<div class="card m-3 mt-3">
 <div class="card-header container">
                <div class="row">
                    <div class="col-6 p-2">
                        <i class="fas fa-table me-1"></i> DANH SÁCH ĐƠN HÀNG ĐANG CHỜ
                    </div>
                    <div class="col-2"></div>
...
<div class="card-body">
	<table class="table table-hover">
		<thead>
			<tr>
				<th>
					<a class="text-dark" href="/DTNsShop/admin/order-manager.html/sort?field=id&sort=${sort}&p=${number}">
						ID
				...
				<th class="text-dark">
					<a class="text-dark" href="/DTNsShop/admin/order-manager.html/sort?field=account.fullname&sort=${sort}&p=${number}">
						Khách hàng
						<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-down-up" viewBox="0 0 16 16">
						  <path fill-rule="evenodd" d="M11.5 15a.5.5 0 0 0 .5-.5V2.707l3.146 3.147a.5.5 0 0 0 .708-.708l-4-4a.5.5 0 0 0-.708 0l-4 4a.5.5 0 1 0 .708.708L11 2.707V14.5a.5.5 0 0 0 .5.5zm-7-14a.5.5 0 0 1 .5.5v11.793l3.146-3.147a.5.5 0 0 1 .708.708l-4 4a.5.5 0 0 1-.708 0l-4-4a.5.5 0 0 1 .708-.708L4 13.293V1.5a.5.5 0 0 1 .5-.5z"/>
						</svg>
				...
				<th>
					<a class="text-dark" href="/DTNsShop/admin/order-manager.html/sort?field=createdate&sort=${sort}&p=${number}">
					Ngày đặt hàng
					<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-down-up" viewBox="0 0 16 16">
						  <path fill-rule="evenodd" d="M11.5 15a.5.5 0 0 0 .5-.5V2.707l3.146 3.147a.5.5 0 0 0 .708-.708l-4-4a.5.5 0 0 0-.708 0l-4 4a.5.5 0 1 0 .708.708L11 2.707V14.5a.5.5 0 0 0 .5.5zm-7-14a.5.5 0 0 1 .5.5v11.793l3.146-3.147a.5.5 0 0 1 .708.708l-4 4a.5.5 0 0 1-.708 0l-4-4a.5.5 0 0 1 .708-.708L4 13.293V1.5a.5.5 0 0 1 .5-.5z"/>
						</svg>
				...
				<th>
					<a class="text-dark" href="/DTNsShop/admin/order-manager.html/sort?field=address&sort=${sort}&p=${number}">
					Địa chỉ
					<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-down-up" viewBox="0 0 16 16">
						  <path fill-rule="evenodd" d="M11.5 15a.5.5 0 0 0 .5-.5V2.707l3.146 3.147a.5.5 0 0 0 .708-.708l-4-4a.5.5 0 0 0-.708 0l-4 4a.5.5 0 1 0 .708.708L11 2.707V14.5a.5.5 0 0 0 .5.5zm-7-14a.5.5 0 0 1 .5.5v11.793l3.146-3.147a.5.5 0 0 1 .708.708l-4 4a.5.5 0 0 1-.708 0l-4-4a.5.5 0 0 1 .708-.708L4 13.293V1.5a.5.5 0 0 1 .5-.5z"/>
						</svg>
		...
		<tbody>
			<c:forEach var="item" items="${orders.content}" varStatus="i">
				<tr>
					...
					<td>${item.address}</td>
					<td class="text-primary">${item.status?'Đã giao':'Đang chờ...'}</td>
					<td class="text-start">
						...
						<button class="ms-1 btn btn-success" style="width:100px;font-size:13px;" data-bs-toggle="modal" data-bs-target="#modalGiaoHang${i.count}">
							Giao hàng
						</button>
					</td>
					<td>
						<!-- Modal Delete -->
						<div class="modal fade" id="modalGiaoHang${i.count}" tabindex="-1" aria-labelledby="exampleModalLabel${i.count}" aria-hidden="true">
						  <div class="modal-dialog">
						    <div class="modal-content">
						      ...
						      <div class="modal-body text-center">
						       <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="green" class="bi bi-pen-fill"
				                    viewBox="0 0 20 20">
				                   <path d="M0 2.5A.5.5 0 0 1 .5 2H2a.5.5 0 0 1 .485.379L2.89 4H14.5a.5.5 0 0 1 .485.621l-1.5 6A.5.5 0 0 1 13 11H4a.5.5 0 0 1-.485-.379L1.61 3H.5a.5.5 0 0 1-.5-.5zM3.14 5l.5 2H5V5H3.14zM6 5v2h2V5H6zm3 0v2h2V5H9zm3 0v2h1.36l.5-2H12zm1.11 3H12v2h.61l.5-2zM11 8H9v2h2V8zM8 8H6v2h2V8zM5 8H3.89l.5 2H5V8zm0 5a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0zm9-1a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0z"/>
				                </svg>
						     	    <h6 class="text-gray" style="font-style: 16px;font-family:sans-serif;">Xác nhận giao hàng cho đơn hàng DH00${item.id} !</h6>
						      </div>
						      <div class="modal-footer">
						        <a href="/DTNsShop/admin/order-manager.html/update/${item.id}" type="button" class="btn btn-danger">
						          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-pen-fill" viewBox="0 0 20 20">
									 <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
	...
	<div class="text-danger">
                ...
                href="/DTNsShop/admin/order-manager.html/sort?field=${field2}&sort=0&p=0">First</a>
                <a class="btn btn-dark  ${orders.number-1 < 0?'disabled':''} "
                    href="/DTNsShop/admin/order-manager.html/sort?field=${field2}&sort=0&p=${orders.number-1 < 0?'0':orders.number-1}">Previous</a>
                <a class="btn btn-dark  ${orders.number+1 > orders.totalPages - 1 ?'disabled':''}"
                    href="/DTNsShop/admin/order-manager.html/sort?field=${field2}&sort=0&p=${orders.number+1 > orders.totalPages - 1 ? orders.totalPages - 1: orders.number+1}">Next</a>
                <a class="btn btn-dark  ${orders.number+1 > orders.totalPages - 1 ?'disabled':''}"
                    href="/DTNsShop/admin/order-manager.html/sort?field=${field2}&sort=0&p=${orders.totalPages-1}">Last</a>
</div>
</div>
</div>
<!-- Modal Edit -->
