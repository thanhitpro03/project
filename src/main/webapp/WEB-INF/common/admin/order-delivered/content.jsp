	...
	<div class="container-fluid">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb mb-0 py-3">
				...
				<li class="breadcrumb-item active fw-light" aria-current="page">Danh sách đơn hàng đã giao</li>
			</ol>
		</nav>
	</div>
</div>
...
<div class="card m-3 mt-3">
 <div class="card-header container">
                <div class="row">
                    <div class="col-6 p-2">
                        <i class="fas fa-table me-1"></i> DANH SÁCH ĐƠN HÀNG ĐÃ GIAO
                    </div>
                    <div class="col-2"></div>
...
<div class="card-body">
	<table class="table table-hover">
		<thead>
			<tr>
				<th>
					<a class="text-dark" href="/DTNsShop/admin/order-delivered.html/sort?field=id&sort=${sort}&p=${number}">
						ID
				...
				<th class="text-dark">
					<a class="text-dark" href="/DTNsShop/admin/order-delivered.html/sort?field=account.fullname&sort=${sort}&p=${number}">
						Khách hàng
						<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-down-up" viewBox="0 0 16 16">
						  <path fill-rule="evenodd" d="M11.5 15a.5.5 0 0 0 .5-.5V2.707l3.146 3.147a.5.5 0 0 0 .708-.708l-4-4a.5.5 0 0 0-.708 0l-4 4a.5.5 0 1 0 .708.708L11 2.707V14.5a.5.5 0 0 0 .5.5zm-7-14a.5.5 0 0 1 .5.5v11.793l3.146-3.147a.5.5 0 0 1 .708.708l-4 4a.5.5 0 0 1-.708 0l-4-4a.5.5 0 0 1 .708-.708L4 13.293V1.5a.5.5 0 0 1 .5-.5z"/>
						</svg>
				...
				<th>
					<a class="text-dark" href="/DTNsShop/admin/order-delivered.html/sort?field=createdate&sort=${sort}&p=${number}">
					Ngày đặt hàng
					<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-down-up" viewBox="0 0 16 16">
						  <path fill-rule="evenodd" d="M11.5 15a.5.5 0 0 0 .5-.5V2.707l3.146 3.147a.5.5 0 0 0 .708-.708l-4-4a.5.5 0 0 0-.708 0l-4 4a.5.5 0 1 0 .708.708L11 2.707V14.5a.5.5 0 0 0 .5.5zm-7-14a.5.5 0 0 1 .5.5v11.793l3.146-3.147a.5.5 0 0 1 .708.708l-4 4a.5.5 0 0 1-.708 0l-4-4a.5.5 0 0 1 .708-.708L4 13.293V1.5a.5.5 0 0 1 .5-.5z"/>
						</svg>
				...
				<th>
					<a class="text-dark" href="/DTNsShop/admin/order-delivered.html/sort?field=address&sort=${sort}&p=${number}">
					Địa chỉ
					<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-down-up" viewBox="0 0 16 16">
						  <path fill-rule="evenodd" d="M11.5 15a.5.5 0 0 0 .5-.5V2.707l3.146 3.147a.5.5 0 0 0 .708-.708l-4-4a.5.5 0 0 0-.708 0l-4 4a.5.5 0 1 0 .708.708L11 2.707V14.5a.5.5 0 0 0 .5.5zm-7-14a.5.5 0 0 1 .5.5v11.793l3.146-3.147a.5.5 0 0 1 .708.708l-4 4a.5.5 0 0 1-.708 0l-4-4a.5.5 0 0 1 .708-.708L4 13.293V1.5a.5.5 0 0 1 .5-.5z"/>
						</svg>
		...
		<tbody>
			<c:forEach var="item" items="${orders.content}" varStatus="i">
				<tr>
					...
					<td>${item.address}</td>
					<td class="text-success">${item.status?'Đã giao':'Đang chờ...'}</td>
					<td class="text-start">
	...
	<div class="text-danger">
                ...
                href="/DTNsShop/admin/order-delivered.html/sort?field=${field2}&sort=0&p=0">First</a>
                <a class="btn btn-dark  ${orders.number-1 < 0?'disabled':''} "
                    href="/DTNsShop/admin/order-delivered.html/sort?field=${field2}&sort=0&p=${orders.number-1 < 0?'0':orders.number-1}">Previous</a>
                <a class="btn btn-dark  ${orders.number+1 > orders.totalPages - 1 ?'disabled':''}"
                    href="/DTNsShop/admin/order-delivered.html/sort?field=${field2}&sort=0&p=${orders.number+1 > orders.totalPages - 1 ? orders.totalPages - 1: orders.number+1}">Next</a>
                <a class="btn btn-dark  ${orders.number+1 > orders.totalPages - 1 ?'disabled':''}"
                    href="/DTNsShop/admin/order-delivered.html/sort?field=${field2}&sort=0&p=${orders.totalPages-1}">Last</a>
</div>
</div>
</div>
<!-- Modal Delete -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <!--  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="red" class="bi bi-pen-fill" viewBox="0 0 20 20">
			 <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
