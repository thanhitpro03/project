...
<title>DTNsShop Admin | Product Color</title>
...
<body>
	<div class="page">
		...
		<div class="page-content d-flex align-items-stretch">
			<%@ include file="/WEB-INF/common/admin/slidebarColor.jsp"%>
			<div class="content-inner w-100">
				<%@ include file="/WEB-INF/common/admin/product-color/content.jsp"%>
