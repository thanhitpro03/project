...
<title>DTNsShop Admin | Report Manager</title>
...
<body>
	<div class="page">
		...
		<div class="page-content d-flex align-items-stretch">
			<%@ include file="/WEB-INF/common/admin/slidebarReport.jsp"%>
			<div class="content-inner w-100">
				<%@ include file="/WEB-INF/common/admin/report-manager/content.jsp"%>
