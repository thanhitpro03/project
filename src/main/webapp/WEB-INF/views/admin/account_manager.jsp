...
<title>DTNsShop Admin | Account Manager</title>
...
<body>
	<div class="page">
		...
		<div class="page-content d-flex align-items-stretch">
			<%@ include file="/WEB-INF/common/admin/slidebarAccount.jsp"%>
			<div class="content-inner w-100">
				<%@ include file="/WEB-INF/common/admin/account-manager/content.jsp"%>
