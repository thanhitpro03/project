                ...
                <div class="col-lg-10 col-xl-8">
                    ...
                    border-bottom: 5px solid rgb(236, 57, 57);border-left: 10px solid black;border-right: 5px solid black;">
                        <div class="card-header px-4 py-5 mb-0" style="background: white;">
                            <h5 class="mb-0">Đơn hàng của tài khoản <span
                                    class="text-black-50">${users.username}</span> !</h5>
                        </div>
                        <div class="card-body p-4">
                            ...
                            <div class="d-flex justify-content-between pt-2">
                                <h6 class="text-muted mb-0 d-flex justify-content-between">Họ tên người nhận : <p class="ms-2 text-danger">${users.fullname}.</p></h6>
                                <p class="text-muted mb-0"><span class="fw-bold me-4">(+) Phí ship:</span> 0 VND</p>
                            </div>

                            <div class="d-flex justify-content-between pt-2">
                            	<h6 class="text-muted mb-0 d-flex justify-content-between">Số điện thoại :<p class="ms-2 text-danger"> ${users.phonenumber}.</p></h6>
                                <p class="text-muted mb-0"><span class="fw-bold me-4">(-) Giảm giá:</span> 0 VND</p>
                                
                            </div>

                            <div class="d-flex justify-content-between pt-2">
                            	<h6 class="text-muted mb-0 d-flex justify-content-between">Email :<p class="ms-2 text-danger"> ${users.email}.</p></h6>
                            </div>
                            ...
                            <div class="d-flex justify-content-between">
                             ...
                             <div class="d-flex justify-content-between">
                                <h6 class="text-dark d-flex justify-content-between mb-0">Trạng thái :<p class="ms-2 ${orders.cancelorder?'text-danger':'text-primary'}">${orders.cancelorder?'Đã hủy.':orders.status?'Đã giao hàng.':'Đang chờ giao hàng.'}</p></h6>
                            </div>
                        ...
                        <div class="card-footer border-0 mb-2"
                            ...
                            <div class="justify-content-start">
                                <a href="/DTNsShop/admin/order-manager.html" class="btn btn-danger">Quay lại trang quản trị</a>
                            </div>
                        </div>
                    </div>
                </div>
