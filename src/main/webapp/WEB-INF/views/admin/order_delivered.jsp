...
<title>DTNsShop Admin | Order Delivered</title>
...
<body>
	<div class="page">
		...
		<div class="page-content d-flex align-items-stretch">
			<%@ include file="/WEB-INF/common/admin/slidebarOrder.jsp"%>
			<div class="content-inner w-100">
				<%@ include file="/WEB-INF/common/admin/order-delivered/content.jsp"%>
