...
<title>DTNsShop Admin | Categories Manager</title>
...
<body>
	<div class="page">
		...
		<div class="page-content d-flex align-items-stretch">
			<%@ include file="/WEB-INF/common/admin/slidebarCategories.jsp"%>
			<div class="content-inner w-100">
				<%@ include file="/WEB-INF/common/admin/categories-manager/content.jsp"%>
