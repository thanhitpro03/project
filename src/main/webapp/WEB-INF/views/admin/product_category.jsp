...
<title>DTNsShop Admin | Product Category</title>
...
<body>
	<div class="page">
		...
		<div class="page-content d-flex align-items-stretch">
			<%@ include file="/WEB-INF/common/admin/slidebarProduct.jsp"%>
			<div class="content-inner w-100">
				<%@ include file="/WEB-INF/common/admin/product-category/content.jsp"%>
