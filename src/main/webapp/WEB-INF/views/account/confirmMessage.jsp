...
<html lang="en">
<head>
	<title>DTNsShop - Confirm Pass Message</title>
	<meta charset="UTF-8">
			...
			<div class="wrap-login100">
				<form class="login100-form validate-form" method="post">
					...
					<div class="wrap-input100">
						...
						<input class="input100 text-white" type="text" name="code">
						<span class="focus-input100" data-placeholder="Enter code"></span>
					</div>
					<div class="alert alert-danger align-items-center bg-white text-danger m-0" role="alert"
					 ${messageC == null && messageE == null?'hidden':''} 
