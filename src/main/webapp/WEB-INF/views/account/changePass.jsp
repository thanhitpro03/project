...
<html lang="en">
<head>
	<title>DTNsShop Change Password ?</title>
	<meta charset="UTF-8">
		...
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" method="post">
					...
					<div class="alert alert-danger align-items-center bg-white text-danger m-0" role="alert" ${messageOP == null && messageNP == null && messageCP == null?'hidden':''} style="font-size: 13px;">
						 	<div>
						 		${messageOP}
						 	</div>
						 	<div>
				...
				<div class="mt-1">
					<a class="txt2 text-danger" href="index.html"> <i class="fa fa-undo"
						aria-hidden="true"></i> Về trang chủ
					</a>
				</div>
			</div>
		</div>
